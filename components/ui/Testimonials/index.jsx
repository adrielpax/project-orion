...
const Testimonials = () => {
  const testimonials = [
    ...
    //   quote:
    //     "My company's software now is easy to use, saves time and money, and is loved by a lot of users. One customer saved $10k over the course of 3 years and another saves 8 hours per week! Thanks to CLICK LAB.",
    // },
    // {
    //   avatar:
    ...
    //   quote:
    //     "One day, my company was about to go under and I had no idea what to do. I found CLICK LAB and it helped me get my business back on track.Now, my company is flourishing and I see new opportunities.",
    // },
    // {
    //   avatar:
    ...
    //   quote:
    //     "We all know how costly it is to find good help. I was faced with this problem when I lost my data entry staff and my business was on the brink of going under. Thankfully, CLICK LAB saved the day.",
    // },
  ];
