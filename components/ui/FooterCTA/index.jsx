    ...
    <div className="custom-screen">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <NavLink
          ...
          text-zinc-900 border-2 border-green-500 bg-gradient-to-tr from-green-400 via-green-600 to-green-900 
              rounded-lg px-6 py-3 shadow-lg transition-all duration-300 ease-in-out active:bg-green-100 
              hover:text-zinc-900 hover:border-green-100 hover:scale-105 hover:shadow-xl 
