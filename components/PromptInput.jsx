...
const PromptInput = ({
  ...
  return (
    <section className="relative">
      <div className="custom-screen py-20 text-white">
        <div className="space-y-8 max-w-4xl mx-auto text-center z-20">
          ...
          <div className="space-y-6">
            <div className="relative">
              <textarea
                ...
                rows={6}
                disabled={isLoading}
                className="w-full p-6 text-white bg-gradient-to-r from-zinc-800/50 to-zinc-900/50 
            ...
            <button
              ...
              className="flex items-center justify-center gap-3 text-white border-2 border-indigo-500 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12 text-center">
            <div className="space-y-2">
              ...
              <h3 className="font-semibold text-white">Resposta Instantânea</h3>
