  ...
  if (showHero) {
    return (
      <div className="min-h-screen bg-translate relative overflow-hidden">
        <section>
          <div className="max-w-6xl mx-auto px-4 py-28 text-zinc-900 relative z-10">
            <div className="space-y-8 max-w-4xl text-center mx-auto">
              <h1 className="text-5xl text-zinc-900 font-extrabold mx-auto sm:text-6xl">
              ...
              <div className="flex flex-col md:flex-row items-center justify-center gap-4 font-medium">
                <button
                  ...
                  className="flex flex-row items-center gap-3 text-zinc-900 border-2 border-indigo-500 bg-gradient-to-tr from-indigo-600 to-blue-600
                ...
                >
                  ...
                  <Share2 className="text-zinc-900 w-5 h-5" />
                </button>
                ...
                <button 
                  ...
                  className="text-zinc-900 border border-gray-500 bg-gradient-to-r from-zinc-700 to-zinc-800
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-zinc-900">LAN File Share</h1>
            ...
            <div className="flex items-center space-x-6">
              <div className="flex items-center space-x-2 bg-white/10 rounded-lg px-4 py-2">
                ...
                <span className="text-zinc-900 font-medium">{connectedDevices.length + 1} online</span>
              </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 p-8">
              ...
              >
                <div className="space-y-4">
                  ...
                  <div>
                    <p className="text-xl text-zinc-900 mb-2">Selecione ou arraste arquivos aqui</p>
                  ...
                  {files.map(file => (
                    ...
                    border border-white/10 rounded-xl hover:bg-white/10 transition-all duration-200 group">
                      <div className="flex items-center space-x-4">
                        ...
                        <div>
                          <p className="font-semibold text-zinc-900 text-lg">{file.name}</p>
                      ...
                      <button
                        ...
                        text-zinc-900 px-6 py-3 rounded-lg flex items-center space-x-2 transition-all duration-200 
          ...
          <div className="space-y-6">
                ...
                {connectedDevices.map(device => (
                  <div key={device.id} className="flex items-center justify-between p-4 bg-white/5 rounded-lg">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <span className="text-zinc-900 font-medium">{device.name}</span>
            ...
            {/* Status da rede */}
            <div className="bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 p-6">
              <h3 className="text-lg font-bold text-zinc-900 mb-4">Status da Rede</h3>
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <span className="text-gray-400">Protocolo:</span>
                  <span className="text-zinc-900 font-medium">WebRTC P2P</span>
                </div>
                <div className="flex items-center justify-between">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-zinc-900 font-mono text-xs">{networkId.slice(-8)}</span>
                </div>
              </div>
            </div>
            ...
            <button
              ...
              text-zinc-900 px-6 py-3 rounded-xl transition-all duration-200 hover:scale-105"
            >
              Voltar ao início
            </button>
          </div>
